...
* **[TUTORIAL.md](TUTORIAL.md)**: **Пошаговое руководство** по запуску симуляций и валидации.
...
* ✅ **Фаза 6**: Валидация (Radar forward operator, Multi-sensor validation)

### Активная фаза

* 🔄 **Фаза 7**: Оптимизация и развёртывание (Numba optimization, Docker)
...
**Статус**: Активная разработка (Фаза 7)
